# Reproducibility
To reproduce the confusion matrix figure of our paper about reproducibility in bioinformatics ([Kim et al. GigaScience 2018](https://doi.org/10.1093/gigascience/giy077)), you have two options:
